...
use super::crystal_cactus_expected_data as expected;
...
fn get_fixture_path() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        ...
        .join("fixture")
        .join("Crystal Cactus.nksf")
}

#[test]
fn test_crystal_cactus_parse_success() {
...
#[test]
fn test_crystal_cactus_complete_parse() {
    let path = get_fixture_path();
    let result = parse_nksf(&path);
    match result {
        Ok(_) => { /* OK */ }
