...
use super::face_the_punch_expected_data as expected;
...
fn get_fixture_path() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        ...
        .join("fixture")
        .join("Face The Punch.nksf")
}

#[test]
fn test_face_the_punch_parse_success() {
...
#[test]
fn test_face_the_punch_complete_parse() {
    let path = get_fixture_path();
    let result = parse_nksf(&path);
    match result {
        Ok(_) => { /* OK */ }
